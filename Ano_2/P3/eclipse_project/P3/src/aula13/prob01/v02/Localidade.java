...
public class Localidade<T extends TipoLocalidade> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Localidade<T> other = (Localidade<T>) obj;
		if (nome == null) {
			if (other.nome != null)
				return false;
	...
	public String toString() {
		return elem.getClass().getSimpleName()+" "+this.nome+", populaçao "+this.populacao;
	}
}
